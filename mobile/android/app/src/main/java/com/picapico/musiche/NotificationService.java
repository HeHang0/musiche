...
public class NotificationService extends Service {
    ...
    public  static final String CHANNEL_ID = "com.picapico.musiche.channel.audio";
    public  static final String MEDIA_SESSION_TAG = "com.picapico.musiche.media.session";
    ...
    public void updateMetaData(String title, String artist, String album, boolean playing, int position, int duration, Bitmap largeIcon){
    ...
    public void updateMediaPosition(boolean playing, int position){
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        boolean lover = intent.getBooleanExtra("lover", false);
        ...
        if(title == null || title.isEmpty()){
            ...
            if (artwork.equals(mLastArtWork) && mLargeIcon != null) {
                ...
                String finalArtwork = artwork;
                mExecutorService.execute(() -> {
                    Bitmap largeIcon;
                    try {
                        URL url = new URL(finalArtwork);
